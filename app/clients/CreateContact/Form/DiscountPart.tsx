...
import AuthorizationController from '@zhava/core/AuthorizationController';
...
const DiscountPart: FC<Props> = ({ clients, selectContact }) => {
    const session = useSession();
    const { role } = session;
    const [clientPackages, { isLoading }] = useQuery(getPackages,
        {
            query: {
                where: {
                    status: "ACTIVE"
    ...
    >
        ...
        >
            ...
            >
                <AuthorizationController showChildrenTo={["USER"]}>
                ...
                <Field
                    ...
                    as={Select}
                    disabled={role === "USER" && selectContact && selectContact.packageId !== undefined}
                    sx={{
                        width: "100%",
                        mb: { xs: 4, xl: 6 },
                    }}
        ...
        >
            ...
            >
                ...
                <Field
                    ...
                    as={Select}
                    disabled={role === "USER" && selectContact && selectContact.parentId !== null}
                    sx={{
                        width: "100%",
                        mb: { xs: 4, xl: 6 },
                    }}
