...
import { LanguageProps } from "@zhava/core/AppLngSwitcher/data";
...
interface ZhavaPalette extends Palette {
  background: {
    paper: string;
    default: string;
  };
...
export interface ZhavaTheme extends Theme {
  direction: Direction;
  cardRadius: number;
  palette: ZhavaPalette;
  status: {
    danger: string;
  };
  divider: string;
